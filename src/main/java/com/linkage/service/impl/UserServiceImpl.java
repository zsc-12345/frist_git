...
import com.linkage.exception.BusinessException;
...
import com.linkage.event.OnRegistrationCompleteEvent;
import com.linkage.repository.UserMapper;
...
public class UserServiceImpl extends BaseServiceImpl<User> implements UserService {
    ...
    public Integer getRoleId(String username) {
        return userMapper.getRoleId(username);
    }
}
