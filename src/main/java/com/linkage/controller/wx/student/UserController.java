...
import com.linkage.domain.enums.RoleEnum;
...
import com.linkage.viewmodel.student.user.*;
...
public class UserController extends BaseWXApiController {
    ...
    public RestResponse register(@Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册凌志线上教育培训系统");
