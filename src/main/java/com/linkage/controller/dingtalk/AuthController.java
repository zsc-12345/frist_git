...
import com.linkage.domain.dingtalk.ConfigDTO;
import com.linkage.domain.dingtalk.ServiceResult;
import com.linkage.domain.dingtalk.UserDTO;
import com.linkage.exception.DingtalkEncryptException;
import com.linkage.service.dingtalk.TokenService;
import com.linkage.utility.dingtalk.JsApiSignature;
...
import static com.linkage.configuration.dingtalk.UrlConstant.URL_GET_USER_INFO;
import static com.linkage.configuration.dingtalk.UrlConstant.URL_USER_GET;
...
public class AuthController {
    ...
    @PostMapping("/config")
    public ServiceResult<ConfigDTO> config(@RequestParam String url) throws DingtalkEncryptException {
